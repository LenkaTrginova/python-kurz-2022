...
#Před tím, než budeš hledat znak ve slovníku, zkontroluj, zda znak není mezera. Pokud ano, vypiš znak lomítka
    if t ==" ":
        t2=t.replace(" ","/")
#Abychom měli celý kód vypsaný na jedné řádce, požádáme funkci print(), aby na konci výpisu nevkládala znak pro konec řádku, ale mezeru.
#To uděláme tak, že jako druhý argument funkce dáme argument end=" ".
        print(morse_code[t2], end="")
    else:
        print(morse_code[t], end="")

#2.Nepovinny bonus 2 - nemám to celé :( nepodařilo se mi přijít na to, jak zakomponovat podmínku s "neznámým regionem" ---------------
staty = [
    {
        "name": "Afghanistan",
        "capital": "Kabul",
...
region = str(input("Zadej název regionu: "))
zeme = []
for x in staty:
    if x["region"]==region:
        zeme = (x["name"])
